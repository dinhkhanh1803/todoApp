...
const AddTask = ({ handleNewTaskAdded }) => {
  ...
  const addTask = async () => {
    if (newTaskTitle.trim()) {
      ...
      toast.warning("Bạn cần nhập nội dung cho nhiệm vụ.");
    }
  };
    ...
    <Card className="p-6 border-0 bg-gradient-card shadow-custom-lg">
      <div className="flex flex-col gap-3 sm:flex-row">
        <Input
          ...
          className="h-12 text-base bg-slate-50 sm:flex-1 border/50 focus:border-primary/50 focus:ring-primary/20"
          value={newTaskTitle}
