  ...
  const updateTask = async ()=>{
    try {
      ...
      handleTaskChanged()
          ...
          console.error("Loi xay ra khi update nhiem vu", error);
  ...
  const toggleTaskCompleteButton = async () =>{
    try {
      ...
      handleTaskChanged()
          ...
          console.error("Loi xay ra khi status nhiem vu", error);
              toast.error("Lỗi xảy ra khi status nhiệm vụ.");
    }
  }
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        ...
        {/* hien thi hoac sua tieu de */}
        <div className="flex-1 min-w-0">
          {isEditing ? (
            <Input
              placeholder="Cần phải làm gi?"
        ...
        {/* Nut chinh xoa */}
        <div className="gap-2 group-hover:inline-flex animate-slide-up hidden">
          <Button
            variant="ghost"
            size="icon"
